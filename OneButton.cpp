...
OneButton::OneButton(int pin, int activeLow)
{
  ...
  _clickTicks = 20;        // number of millisec that have to pass by before a click is detected.
  _pressTicks = 40;       // number of millisec that have to pass by before a long button press is detected.
